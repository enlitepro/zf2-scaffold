...
use Scaffold\Builder\Controller\RESTControllerBuilder;
...
class RESTControllerBuilderTest extends AbstractBuilderTestCase
{

    public function testPrepare()
    {
        $builder = new RESTControllerBuilder($this->getConfig());
